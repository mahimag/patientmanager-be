...
var signin = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logger_1.default.info("this is a test!!");
                return [4, UserAccount_1.default.getUserByEmail(email)];
            case 1:
                user = _a.sent();
                logger_1.default.info("this is after the test!!");
                if (!user) {
                    return [2, {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, UserAccount_1.default.getAllUsers()];
            case 1:
                users = _a.sent();
                return [2, {
                        data: users,
...
var getUser = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logger_1.default.info("Getting user with id: ".concat(userId));
                return [4, UserAccount_1.default.getUser(userId)];
            case 1:
                user = _a.sent();
                return [2, {
                        data: user,
