...
var authenticate = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4, jsonwebtoken_1.default.verify(accessToken, process.env.JWT_SECRET)];
            case 2:
                result = _b.sent();
                console.log(result);
                next();
            ...
            case 3:
                err_1 = _b.sent();
                next(new CustomError_1.default("Invalid access token", 401));
                return [3, 4];
            case 4: return [2];
        }
    });
